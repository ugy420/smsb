...
const Home = () => {
  ...
  return (
    <div className="container mx-auto mt-10 p-28">
     ...
     {/* Footer */}
<footer className="bg-gradient-to-r from-[#604CC3] via-[#80C4E9] to-[#FF7F3E] text-[#FFF6E9] py-12 mt-10">
  <div className="container mx-auto px-6 sm:px-8">
    <div className="flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0 md:space-x-10">

      {/* Logo and Brand */}
      <div className="text-center md:text-left">
        <h2 className="text-3xl font-extrabold text-[#FFF6E9] tracking-wide transform hover:scale-105 transition duration-300 ease-in-out">
          Sports Ground Booking
        </h2>
        <p className="text-base mt-2 text-[#FFF6E9] opacity-80 hover:opacity-100 transition-opacity duration-300 max-w-xs">
          Book sports grounds seamlessly and enjoy sports at your convenience.
        </p>
      </div>

      {/* Footer Links */}
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-8 text-base text-[#FFF6E9]">
        <Link to="/about" className="hover:text-[#FF7F3E] transform transition duration-300">About Us</Link>
        <Link to="/contact" className="hover:text-[#FF7F3E] transform transition duration-300">Contact</Link>
        <Link to="/privacy-policy" className="hover:text-[#FF7F3E] transform transition duration-300">Privacy Policy</Link>
        <Link to="/terms-of-service" className="hover:text-[#FF7F3E] transform transition duration-300">Terms of Service</Link>
      </div>

      {/* Social Media Icons */}
      <div className="flex space-x-6 text-[#FFF6E9]">
        <a href="#" className="hover:text-[#FF7F3E] transform hover:scale-110 transition duration-300">
    ...
    {/* Divider */}
    <div className="my-8 border-t border-[#FFF6E9] opacity-50"></div>

    {/* Copyright */}
    <div className="text-center text-sm text-[#FFF6E9] opacity-80 hover:opacity-100 transition-opacity duration-300">
